...
class KVCache(torch.nn.Module):
    ...
    def __init__(
        ...
        :meth:`prefill` and can change with any such call. If this is smaller
        than `batch_size`, then in general only parts of the buffers are used.
    ...
    def forward(
        ...
        or the eviction logic is fixed up front.
        ...
        `num` may lead to worse decisions. On the other hand, ingesting prompts
        with larger `num` is faster.
